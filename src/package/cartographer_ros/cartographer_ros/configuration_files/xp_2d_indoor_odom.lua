...
include "xm_map_builder_odom.lua"
include "xm_trajectory_builder_odom.lua"
...
options = {
  ...
  use_pose_extrapolator = true,                         -- Inference pose from imu, odom
  use_odometry = true,
  use_nav_sat = false,
  use_landmarks = false,
  ...
  publish_frame_projected_to_2d = true,                 -- TODO:
